            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 col-md-12">
                    <div class="welcome-content v2">
                        <div class="promo-section">
                            <div class="integration-link light">
                                <span class="integration-icon">
                                    <img src="<?=asset('assets/frontend/img/svg/img-dollar.svg')?>" width="24" height="24" alt="">
                                </span>
                        ...
                        <div class="dream-btn-group wow fadeInUp" data-wow-delay="0.4s">
                            <a href="#" class="btn dream-btn green-btn mr-3">CV Create</a>
                ...
                <div class="col-12 col-lg-6 col-md-12">
                    <div class="banner-box">
                        <img src="<?=asset('assets/frontend/img/core-img/banner2.png')?>" alt="">
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="services-block-four">
                        <div class="inner-box">
                            <div class="icon-img-box">
                                <img src="<?=asset('assets/frontend/img/icons/d1.png')?>" alt="">
                            </div>
                    ...
                    <div class="services-block-four">
                        <div class="inner-box">
                            <div class="icon-img-box">
                                <img src="<?=asset('assets/frontend/img/icons/d2.png')?>" alt="">
                            </div>
                    ...
                    <div class="services-block-four" style="margin-bottom:0">
                        <div class="inner-box">
                            <div class="icon-img-box">
                                <img src="<?=asset('assets/frontend/img/icons/d3.png')?>" alt="">
                            </div>
            ...
            <div class="row align-items-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="side-feature-list-item">
                                        <img src="<?=asset('assets/frontend/img/icons/check.png')?>" class="check-mark-icon" alt="">
                ...
                <div class="col-12 col-lg-6">
                    <div class="welcome-meter wow fadeInUp mt-s" data-wow-delay="0.3s">
                        <img src="<?=asset('assets/frontend/img/core-img/cv.png')?>" class="center-block" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="container section-padding-0-100">
        <div class="subscribe">
            <div class="row align-items-center relative">
                <img src="<?=asset('assets/frontend/img/core-img/custom.png')?>" alt="" class="custom">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="demo-item">
                        <a href="template-preview.html"><img src="<?=asset('assets/frontend/img/demos/demo-1.png')?>" alt="demo" class="img-responsive"></a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="demo-item">
                        <a href="template-preview.html"><img src="<?=asset('assets/frontend/img/demos/demo-2.png')?>" alt="demo" class="img-responsive"></a>
                        <div class="preview-btn-wrapper text-center">
                            <a href="template-preview.html" class="preview-demo">See template <i class="fa fa-long-arrow-right"></i></a>
                            <a href="template-edit.html" class="preview-demo v2">Use template <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="demo-item">
                        <a href="template-preview.html"><img src="<?=asset('assets/frontend/img/demos/demo-3.png')?>" alt="demo" class="img-responsive"></a>
                        <div class="preview-btn-wrapper text-center">
                            <a href="template-preview.html" class="preview-demo">See template <i class="fa fa-long-arrow-right"></i></a>
                            <a href="template-edit.html" class="preview-demo v2">Use template <i class="fa fa-long-arrow-right"></i></a>
                        </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="service_icon">
                            <img src="<?=asset('assets/frontend/img/icons/f1.png')?>" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 wow wow fadeInUp" data-wow-delay="0.3s">
                        <!-- Icon -->
                        <div class="service_icon">
                            <img src="<?=asset('assets/frontend/img/icons/f2.png')?>" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 wow fadeInUp" data-wow-delay="0.4s">
                        <!-- Icon -->
                        <div class="service_icon">
                            <img src="<?=asset('assets/frontend/img/icons/f3.png')?>" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 wow fadeInUp" data-wow-delay="0.5s">
                        <!-- Icon -->
                        <div class="service_icon">
                            <img src="<?=asset('assets/frontend/img/icons/f4.png')?>" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 wow fadeInUp" data-wow-delay="0.6s">
                        <!-- Icon -->
                        <div class="service_icon">
                            <img src="<?=asset('assets/frontend/img/icons/f5.png')?>" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 wow fadeInUp" data-wow-delay="0.7s">
                        <!-- Icon -->
                        <div class="service_icon">
                            <img src="<?=asset('assets/frontend/img/icons/f6.png')?>" alt="">
                        </div>
                    ...
                    <div class="client_slides owl-carousel">
                        ...
                        <div class="single-testimonial text-center">
                            ...
                            <div class="testimonial_image">
                                <img src="<?=asset('assets/frontend/img/test-img/1.jpg')?>" alt="">
                            </div>
                        ...
                        <div class="single-testimonial text-center">
                            ...
                            <!-- Testimonial Image -->
                            <div class="testimonial_image">
                                <img src="<?=asset('assets/frontend/img/test-img/2.jpg')?>" alt="">
                            </div>
                            <!-- Testimonial Feedback Text  -->
                            <div class="testimonial-description">
                                <div class="testimonial_text">
                        ...
                        <div class="single-testimonial text-center">
                            ...
                            <!-- Testimonial Image -->
                            <div class="testimonial_image">
                                <img src="<?=asset('assets/frontend/img/test-img/3.jpg')?>" alt="">
                            </div>
                            <!-- Testimonial Feedback Text  -->
                            <div class="testimonial-description">
                                <div class="testimonial_text">
